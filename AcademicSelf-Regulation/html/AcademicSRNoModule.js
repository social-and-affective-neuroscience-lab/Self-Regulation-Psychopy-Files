...
function QuestionTrialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = QuestionTrials[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisQuestionTrial = result.value;
...
function Questions5LoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = Questions5[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisQuestions5 = result.value;
...
function GameTrialsLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  trialIterator = GameTrials[Symbol.iterator]();
  while(true) {
    let result = trialIterator.next();
    if (result.done);
      break;
    let thisGameTrial = result.value;
...
function testQuestionsChoiceRoutineBegin() {
  ...
  testQuestionsChoiceComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function qInstRoutineBegin() {
  ...
  qInstComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function testQsRoutineBegin() {
  ...
  testQsComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
...
function pacmanRoutineBegin() {
  ...
  pacmanComponents.forEach( function(thisComponent) {
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
     });
